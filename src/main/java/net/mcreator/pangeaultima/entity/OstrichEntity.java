...
public class OstrichEntity extends PathfinderMob implements IAnimatable {
	...
	public OstrichEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.OSTRICH.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.OSTRICH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(OstrichEntity.RemovalReason.KILLED);
		}
	}
