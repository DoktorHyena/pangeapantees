...
public class WildebeestEntity extends Animal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public WildebeestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.WILDEBEEST.get(), world);
	}

	public WildebeestEntity(EntityType<WildebeestEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, TigerEntity.class, (float) 6, 1, 1.2));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WildebeestEntity retval = PangeaUltimaModEntities.WILDEBEEST.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Blocks.GRASS.asItem(), Blocks.DEAD_BUSH.asItem(), Blocks.GRASS.asItem(), Blocks.FERN.asItem(), Blocks.TALL_GRASS.asItem(),
				Blocks.SEAGRASS.asItem(), Blocks.TALL_SEAGRASS.asItem()).contains(stack.getItem());
	}

	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.WILDEBEEST.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WildebeestEntity.RemovalReason.KILLED);
		}
	}
