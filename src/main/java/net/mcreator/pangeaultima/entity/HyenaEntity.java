...
import net.mcreator.pangeaultima.procedures.HyenaOnEntityTickUpdateProcedure;
import net.mcreator.pangeaultima.init.PangeaUltimaModEntities;

public class HyenaEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public HyenaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.HYENA.get(), world);
	}

	public HyenaEntity(EntityType<HyenaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pangea_ultima:hyenawhoop"));
	}
	...
	public void baseTick() {
		super.baseTick();
		HyenaOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.HYENA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HyenaEntity.RemovalReason.KILLED);
		}
	}
