...
public class CoyoteEntity extends Animal implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public CoyoteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.COYOTE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, Monster.class, (float) 6, 1, 1.2));
		...
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, GazelleEntity.class, false, true));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		CoyoteEntity retval = PangeaUltimaModEntities.COYOTE.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.COYOTE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CoyoteEntity.RemovalReason.KILLED);
		}
	}
