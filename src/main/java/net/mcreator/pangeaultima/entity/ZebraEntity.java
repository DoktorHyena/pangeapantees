...
import net.mcreator.pangeaultima.procedures.ZebraRunProcedure;
import net.mcreator.pangeaultima.init.PangeaUltimaModEntities;

import java.util.List;

public class ZebraEntity extends Animal implements IAnimatable {
	...
	public ZebraEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.ZEBRA.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, HyenaEntity.class, (float) 6, 1.2, 1.2));
		this.targetSelector.addGoal(4, new HurtByTargetGoal(this));
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Fox.class, false, true));
	...
	public void baseTick() {
		super.baseTick();
		ZebraRunProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ZebraEntity retval = PangeaUltimaModEntities.ZEBRA.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.ZEBRA.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ZebraEntity.RemovalReason.KILLED);
		}
	}
