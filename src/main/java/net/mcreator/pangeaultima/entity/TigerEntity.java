...
public class TigerEntity extends Monster implements IAnimatable {
	...
	public TigerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.TIGER.get(), world);
	}
	...
	public SoundEvent getHurtSound(DamageSource ds) {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("pangea_ultima:growl"));
	}
	...
	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.TIGER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(TigerEntity.RemovalReason.KILLED);
		}
	}
