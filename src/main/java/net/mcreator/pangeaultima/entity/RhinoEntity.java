...
public class RhinoEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public RhinoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PangeaUltimaModEntities.RHINO.get(), world);
	}

	public RhinoEntity(EntityType<RhinoEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(PangeaUltimaModEntities.RHINO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(RhinoEntity.RemovalReason.KILLED);
		}
	}
